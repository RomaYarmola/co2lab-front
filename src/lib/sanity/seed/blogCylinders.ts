...
export const postCylinderCapacity: SeedPost = {
  ...
  body: body(
    {
      en: [
        ...
        ["h2", "How long a cylinder lasts"],
        ["tbl", "Typical figures; real use depends on flow setting, line length and temperature", "Use | 10 l cylinder (6–7 kg) | 40 l cylinder (24–28 kg)", "Welding post, 12 l/min, 50% arc-on | about one shift | 4–5 shifts", "Beer dispensing, 50 l kegs | 40–60 kegs | 150–220 kegs", "Soda and drinks machine | several weeks | several months"],
        ["p", "A welding post at 12 l/min draws about 1.3 kg of CO₂ an hour of arc. For dispensing, most of the gas goes on pushing beer out of the keg, so a long line and high pressure shorten the figures noticeably."],
        ["h2", "How many atmospheres are in a full cylinder"],
        ["tbl", "Pressure of liquefied CO₂ depends only on temperature while liquid remains", "Cylinder temperature | Pressure, bar (absolute)", "−20 °C | ≈ 20", "0 °C | ≈ 35", "+15 °C | ≈ 51", "+20 °C | ≈ 57", "+31 °C | ≈ 74 — critical point, the liquid disappears"],
        ["p", "That is why the gauge says nothing about how much is left: a cylinder at 20 °C shows about 56 bar both when full and with a kilogram of liquid remaining. The pressure only starts to fall when the liquid is gone. The reliable method is to weigh the cylinder and subtract the tare stamped on the neck."],
        ...
        ["p", `In most cases the arithmetic turns at somewhere between one and two tonnes a month. Below that, cylinders win on simplicity; above it, a [10–20 m³ tank](${categoryPath(catTanksCo2, "en")}) pays for itself in a year or two on the price of gas alone.`],
      ...
      uk: [
        ...
        ["h2", "На скільки вистачає балона"],
        ["tbl", "Типові цифри; реальна витрата залежить від налаштування, довжини лінії й температури", "Застосування | Балон 10 л (6–7 кг) | Балон 40 л (24–28 кг)", "Зварювальний пост, 12 л/хв, 50% горіння дуги | приблизно одна зміна | 4–5 змін", "Розлив пива, кеги 50 л | 40–60 кег | 150–220 кег", "Сифон і апарат для газування | кілька тижнів | кілька місяців"],
        ["p", "Зварювальний пост на 12 л/хв відбирає близько 1,3 кг CO₂ за годину горіння дуги. На розливі більшість газу йде на витискання пива з кеги, тож довга лінія й високий тиск помітно скорочують ці цифри."],
        ["h2", "Скільки атмосфер у повному балоні"],
        ["tbl", "Тиск зрідженого CO₂ залежить лише від температури, поки в балоні є рідина", "Температура балона | Тиск, бар (абсолютний)", "−20 °C | ≈ 20", "0 °C | ≈ 35", "+15 °C | ≈ 51", "+20 °C | ≈ 57", "+31 °C | ≈ 74 — критична точка, рідина зникає"],
        ["p", "Саме тому манометр не показує залишок: балон за 20 °C показує близько 56 бар і повним, і з останнім кілограмом рідини. Тиск починає падати лише тоді, коли рідина скінчилась. Надійний спосіб — зважити балон і відняти тару, вибиту на горловині."],
        ...
        ["p", `У більшості випадків арифметика перевертається десь між однією і двома тоннами на місяць. Нижче цієї межі виграють балони простотою; вище — [ємність на 10–20 м³](${categoryPath(catTanksCo2, "uk")}) окупається за рік-два самою лише ціною газу.`],
      ...
      ru: [
        ...
        ["h2", "На сколько хватает баллона"],
        ["tbl", "Типовые цифры; реальный расход зависит от настройки, длины линии и температуры", "Применение | Баллон 10 л (6–7 кг) | Баллон 40 л (24–28 кг)", "Сварочный пост, 12 л/мин, 50% горения дуги | примерно одна смена | 4–5 смен", "Розлив пива, кеги 50 л | 40–60 кег | 150–220 кег", "Сифон и аппарат для газирования | несколько недель | несколько месяцев"],
        ["p", "Сварочный пост на 12 л/мин отбирает около 1,3 кг CO₂ за час горения дуги. На розливе большая часть газа уходит на вытеснение пива из кеги, поэтому длинная линия и высокое давление заметно сокращают эти цифры."],
        ["h2", "Сколько атмосфер в полном баллоне"],
        ["tbl", "Давление сжиженного CO₂ зависит только от температуры, пока в баллоне есть жидкость", "Температура баллона | Давление, бар (абсолютное)", "−20 °C | ≈ 20", "0 °C | ≈ 35", "+15 °C | ≈ 51", "+20 °C | ≈ 57", "+31 °C | ≈ 74 — критическая точка, жидкость исчезает"],
        ["p", "Именно поэтому манометр не показывает остаток: баллон при 20 °C показывает около 56 бар и полным, и с последним килограммом жидкости. Давление начинает падать только тогда, когда жидкость закончилась. Надёжный способ — взвесить баллон и вычесть тару, выбитую на горловине."],
        ...
        ["p", `В большинстве случаев арифметика переворачивается где-то между одной и двумя тоннами в месяц. Ниже этой границы выигрывают баллоны простотой; выше — [ёмкость на 10–20 м³](${categoryPath(catTanksCo2, "ru")}) окупается за год-два одной только ценой газа.`],
  ...
  faq: [
    ...
    faq(
      "faq-cyl-cap-3",
      {
        en: "How long does a 10 l CO₂ cylinder last?",
        uk: "На скільки вистачає балона вуглекислоти 10 л?",
        ru: "На сколько хватает баллона углекислоты 10 л?",
      },
      {
        en: "A 10 l cylinder holds 6–7 kg of CO₂. That is about one shift for a welding post at 12 l/min with half the time under arc, or roughly 40–60 kegs of beer at normal dispensing pressure.",
        uk: "У балоні 10 л — 6–7 кг CO₂. Це приблизно одна зміна для зварювального поста на 12 л/хв із половиною часу під дугою або близько 40–60 кег пива за звичайного тиску подачі.",
        ru: "В баллоне 10 л — 6–7 кг CO₂. Это примерно одна смена для сварочного поста на 12 л/мин с половиной времени под дугой или около 40–60 кег пива при обычном давлении подачи.",
      },
    ),
    faq(
      "faq-cyl-cap-2",
  ...
  seo: {
    metaTitle: {
      en: "A 40 l cylinder holds 24–28 kg of CO₂: 10–50 l table",
      uk: "Балон 40 л — це 24–28 кг CO₂: таблиця для 10–50 л",
      ru: "Баллон 40 л — это 24–28 кг CO₂: таблица для 10–50 л",
    },
    metaDescription: {
      en: "24–28 kg and 13–15 m³ of gas in a 40 l cylinder. How long it lasts, how many bar a full cylinder holds and at what consumption a tank is cheaper.",
      uk: "У балоні 40 л — 24–28 кг і 13–15 м³ газу. На скільки його вистачає, скільки атмосфер у повному балоні й з якого споживання ємність дешевша.",
      ru: "В баллоне 40 л — 24–28 кг и 13–15 м³ газа. На сколько его хватает, сколько атмосфер в полном баллоне и с какого потребления ёмкость дешевле.",
    },
    keywords: {
...
export const postCylinderMarking: SeedPost = {
  ...
  seo: {
    metaTitle: {
      en: "Gas cylinder colours: CO₂, nitrogen, oxygen, ammonia, chlorine",
      uk: "Колір балонів із газами: CO₂, азот, кисень, аміак, хлор",
      ru: "Цвет баллонов с газами: CO₂, азот, кислород, аммиак, хлор",
    },
    metaDescription: {
