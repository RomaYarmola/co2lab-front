...
export const postTankVolume: SeedPost = {
  ...
  body: body(
    {
      en: [
        ...
        ["p", "Liquid CO₂ is stored at about −20 °C with a density near 1.03 t/m³, and tanks are filled to 90–95% of geometric volume. In round numbers: 10 m³ is about 9.5 tonnes, 30 m³ about 29 tonnes, 50 m³ about 48 tonnes. Manufacturer data sheets show more: the ZVT 30 at 29.55 m³ is rated at 30,965 kg. The maker counts colder, denser liquid (about 1.1 t/m³) at 95% fill; at a storage pressure of 18–22 bar the liquid is warmer, so plan for 5–8% less than the rated figure."],
        ["h2", "Typical configurations"],
        ["li", "3–6 m³ — a small brewery or bottling line moving from cylinders to liquid CO₂."],
        ...
        ["li", "40–60 m³ — large production, dry ice workshop, greenhouse complex, several consumers at once."],
        ["li", "Several 50–60 m³ tanks — CO₂ distributors and large greenhouse complexes; for one greenhouse business we installed [four 60 m³ tanks](/projects)."],
        ...
        ["li", "Peak demand is covered by the vaporizer, not by the tank. A 50 m³ tank with a 130 kg/h vaporizer will not save a line that needs 400 kg/h."],
      ...
      uk: [
        ...
        ["p", "Рідкий CO₂ зберігається за температури близько −20 °C, густина — близько 1,03 т/м³, а заповнюють ємність на 90–95% геометричного обʼєму. Округлено: 10 м³ — це приблизно 9,5 тонни, 30 м³ — близько 29 тонн, 50 м³ — близько 48 тонн. У паспортах виробників цифри вищі: ZVT 30 на 29,55 м³ розрахована на 30 965 кг. Виробник рахує для холоднішої й щільнішої рідини (близько 1,1 т/м³) при заповненні 95%; за тиску зберігання 18–22 бар рідина тепліша, тож закладайте на 5–8% менше за паспортну цифру."],
        ["h2", "Типові конфігурації"],
        ["li", "3–6 м³ — невелика пивоварня чи лінія розливу, що переходить із балонів на рідкий CO₂."],
        ...
        ["li", "40–60 м³ — велике виробництво, цех сухого льоду, тепличний комплекс, кілька споживачів одночасно."],
        ["li", "Кілька ємностей по 50–60 м³ — дистрибʼютори CO₂ і великі тепличні комплекси: для одного тепличного господарства ми змонтували [чотири ємності по 60 м³](/uk/projects)."],
        ...
        ["li", "Пікове споживання закриває випарник, а не ємність. Ємність на 50 м³ з випарником на 130 кг/год не врятує лінію, якій потрібно 400 кг/год."],
      ...
      ru: [
        ...
        ["p", "Жидкий CO₂ хранится при температуре около −20 °C, плотность — около 1,03 т/м³, а заполняют ёмкость на 90–95% геометрического объёма. Округлённо: 10 м³ — это примерно 9,5 тонны, 30 м³ — около 29 тонн, 50 м³ — около 48 тонн. В паспортах производителей цифры выше: ZVT 30 на 29,55 м³ рассчитана на 30 965 кг. Производитель считает для более холодной и плотной жидкости (около 1,1 т/м³) при заполнении 95%; при давлении хранения 18–22 бар жидкость теплее, поэтому закладывайте на 5–8% меньше паспортной цифры."],
        ["h2", "Типовые конфигурации"],
        ["li", "3–6 м³ — небольшая пивоварня или линия розлива, которая переходит с баллонов на жидкий CO₂."],
        ...
        ["li", "40–60 м³ — крупное производство, цех сухого льда, тепличный комплекс, несколько потребителей одновременно."],
        ["li", "Несколько ёмкостей по 50–60 м³ — дистрибьюторы CO₂ и крупные тепличные комплексы: для одного тепличного хозяйства мы смонтировали [четыре ёмкости по 60 м³](/ru/projects)."],
        ...
        ["li", "Пиковое потребление закрывает испаритель, а не ёмкость. Ёмкость на 50 м³ с испарителем на 130 кг/ч не спасёт линию, которой нужно 400 кг/ч."],
  ...
  seo: {
    ...
    metaDescription: {
      en: "Consumption, delivery interval, boil-off: how to size a liquid CO₂ tank from 3 to 60 m³ and not overpay for volume you will not use.",
      uk: "Споживання, інтервал поставок, втрати на випаровування: як розрахувати ємність для рідкого CO₂ на 3–60 м³ і не переплатити за зайвий обʼєм.",
      ru: "Потребление, интервал поставок, потери на испарение: как рассчитать ёмкость для жидкого CO₂ на 3–60 м³ и не переплатить за лишний объём.",
    },
    keywords: {
...
export const postCylinderVsTank: SeedPost = {
  ...
  relatedProducts: [seedProduct("product-cryocylinder-180-4"), seedProduct("product-tank-n2-10")],
  relatedPosts: [],
  seo: {
    metaTitle: {
...
export const postGreenhouseVaporizer: SeedPost = {
  ...
  body: body(
    {
      ...
      uk: [
        ...
        ["p", "Орієнтовно закрита теплиця споживає близько 30–60 кг CO₂ на гектар за годину в піковий період, залежно від вентиляції та цільової концентрації, яку зазвичай тримають на рівні 700–1000 ppm проти приблизно 420 ppm у зовнішньому повітрі. Для пʼяти гектарів це 150–300 кг/год, тобто розумний вибір — випарник на 400 кг/год (P400E/3W) із запасом."],
  ...
  relatedProducts: [
    seedProduct("product-co2-vaporizer-400"),
    seedProduct("product-co2-vaporizer-650"),
