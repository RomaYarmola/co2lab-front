 ...
 *
 * RU прихована за рішенням клієнта: сторінки існують і відкриваються
 * за прямим URL, але в інтерфейсі їх не пропонуємо. Ціна рішення відома:
 * єдине, що веде Google на /ru, — sitemap і hreflang із твінів; жодного
 * внутрішнього посилання немає, тож розділ залишається в статусі
 * «обнаружена, не проиндексирована» довше, ніж міг би.
 */
