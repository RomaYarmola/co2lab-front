...
export const dryIceLanding: Landing = {
  ...
  body: {
    uk: [
      ...
      ["p", "Звідси головне обмеження цеху: ємність підбирають під графік поставок сировини, а не під каталог. Для лінії 200 кг/год на повних змінах [ємність на 50 м³](cat:cat-tanks-co2) — це менше двох тижнів запасу."],
    ...
    en: [
      ...
      ["p", "This is the workshop's main constraint: the tank is sized to the raw material delivery schedule, not to the catalogue. For a 200 kg/h line running full shifts, a [50 m³ tank](cat:cat-tanks-co2) is less than two weeks of supply."],
    ...
    ru: [
      ...
      ["p", "Отсюда главное ограничение цеха: ёмкость подбирают под график поставок сырья, а не под каталог. Для линии 200 кг/ч на полных сменах [ёмкость на 50 м³](cat:cat-tanks-co2) — это меньше двух недель запаса."],
